...
<div class="container">
    ...
    <a href="{{ route('stok.create') }}" class="btn-primary">
        Tambah Stok
    </a>
            ...
            <tbody>
                @forelse ($stoks as $stok)
                    <tr>
                        ...
                        <td>
                            <a href="{{ route('stok.edit', $stok->id_barang) }}" class="action-link">Edit</a>
                        </td>
                        <td>
                ...
                @empty
                    <tr>
                        <td colspan="7" style="text-align: center; color: #718096; padding: 1rem;">Tidak ada data stok.</td>
                    </tr>
                @endforelse
            </tbody>
        </table>
