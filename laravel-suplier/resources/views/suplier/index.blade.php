...
<div class="container">
    ...
    <a href="{{ route('suplier.create') }}" class="btn-primary">
        Tambah suplier
    </a>
            ...
            <tbody>
                @forelse ($supliers as $suplier)
                    <tr>
                        ...
                        <td>{{ $suplier->telepon_supplier }}</td>
                        <td>
                            <a href="{{ route('suplier.edit', $suplier->id) }}" class="action-link">Edit</a>
                ...
                @empty
                    <tr>
                        <td colspan="7" style="text-align: center; color: #718096; padding: 1rem;">Tidak ada data suplier.</td>
                    </tr>
                @endforelse
            </tbody>
        </table>
