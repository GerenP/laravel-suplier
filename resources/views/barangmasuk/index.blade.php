...
<div class="container">
    ...
    <a href="{{ route('barangmasuk.create') }}" class="btn-primary">
        Tambah Barang
    </a>
            ...
            <tbody>
                @forelse ($barangmasuks as $barangmasuk)
                    <tr>
                        ...
                        <td>{{ $barangmasuk->id_suplier }}</td>
                        <td>
                            <a href="{{ route('barangmasuk.edit', $barangmasuk->id_barang) }}" class="action-link">Edit</a>
                        </td>
                        <td>
                            <form action="{{ route('barangmasuk.destroy', $barangmasuk->id_barang) }}" method="POST" style="display: inline;">
                                @csrf
                                @method('DELETE')
